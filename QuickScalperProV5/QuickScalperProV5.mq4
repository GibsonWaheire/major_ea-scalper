...
void OnDeinit(const int reason)
{
   ...
   Print("QuickScalperPro EA v5.00 Deinitialized. Reason: ", reason);
}
...
int OpenScalpTrade(int orderType)
{
   ...
   string comment = "ScalpProV5 " + (orderType == OP_BUY ? "BUY" : "SELL") + " Lot:" + DoubleToString(lotSize, 2);
...
bool SubmitPendingOrder(int pendingType, double price)
{
   ...
   string comment = "ScalpProV5 " + side + " Lot:" + DoubleToString(lotSize, 2);
