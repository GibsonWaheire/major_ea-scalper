...
# Script to copy MeanReversionScalper_v2.mq5 to MetaTrader 5 Experts folder
# Usage: ./copy_meanreversion_to_mt5.sh
...
# Source file
SOURCE_FILE="MeanReversionScalperMT5/MeanReversionScalper_v2.mq5"
...
echo "=========================================="
echo "Mean Reversion Scalper v2 - MetaTrader 5 Copy Script"
echo "=========================================="
echo ""
...
if [ -z "$MT5_EXPERTS_DIR" ]; then
    ...
    if [ -z "$MT5_EXPERTS_DIR" ]; then
        ...
        echo "  To:   [Your MT5 Installation]/MQL5/Experts/MeanReversionScalper_v2.mq5"
        echo ""
...
DEST_FILE="$MT5_EXPERTS_DIR/MeanReversionScalper_v2.mq5"
...
if [ $? -eq 0 ]; then
    ...
    echo "3. Find 'MeanReversionScalper_v2.mq5' in the Navigator (under Experts)"
