...
# Script to copy PureMomentumScalperMT5.mq5 to MetaTrader 5 Experts folder
# Usage: ./copy_puremomentum_to_mt5.sh
...
echo "=========================================="
echo "Pure Momentum Scalper - MetaTrader 5 Copy Script"
echo "=========================================="
echo ""
