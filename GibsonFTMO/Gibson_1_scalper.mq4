#property copyright "Gibson_1 Scalper"
#property link      "https://www.mcgibsdigitalsolutions.com"
#property version   "1.00"
#property strict

// ============================================================================
// GIBSON_1 SCALPER — PROFESSIONAL EDITION
...
void OpenTrade(int direction)
{
   ...
   if(ticket > 0)
   {
      ...
      Print("Gibson_1 TRADE OPENED → ", (direction==1?"BUY":"SELL"),
...
void CloseTrade(string reason)
{
   ...
   if(ok)
   {
      Print("Gibson_1 TRADE CLOSED → ", reason, " | Profit: ", profit);
      hasTrade = false;
   }
}
