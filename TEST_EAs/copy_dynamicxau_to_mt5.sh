...
# Script to copy DynamicXauBasketMT5.mq5 to MetaTrader 5 Experts folder
# Usage: ./copy_dynamicxau_to_mt5.sh
...
# Source file
SOURCE_FILE="DynamicXauBasketMT5/DynamicXauBasketMT5.mq5"
...
echo "=========================================="
echo "DynamicXauBasketMT5 - MetaTrader 5 Copy Script"
echo "=========================================="
echo ""
...
if [ -z "$MT5_EXPERTS_DIR" ]; then
    ...
    if [ -z "$MT5_EXPERTS_DIR" ]; then
        ...
        echo "  To:   [Your MT5 Installation]/MQL5/Experts/DynamicXauBasketMT5.mq5"
        echo ""
...
DEST_FILE="$MT5_EXPERTS_DIR/DynamicXauBasketMT5.mq5"
...
if [ $? -eq 0 ]; then
    ...
    echo "3. Find 'DynamicXauBasketMT5.mq5' in the Navigator (under Experts)"
