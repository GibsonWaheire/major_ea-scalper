...
# Script to copy HyperactiveHFTMT5_GOLD.mq5 to MetaTrader 5 Experts folder
...
SOURCE_FILE="$SCRIPT_DIR/HyperactiveHFTMT5_GOLD.mq5"
...
echo "=========================================="
echo "HyperactiveHFTMT5_GOLD - MetaTrader 5 Copy Script"
echo "=========================================="
echo ""
...
if [ -z "$MT5_EXPERTS_DIR" ]; then
    ...
    if [ -z "$MT5_EXPERTS_DIR" ]; then
        ...
        echo "  To:   [Your MT5 Installation]/MQL5/Experts/HyperactiveHFTMT5_GOLD.mq5"
        echo ""
...
DEST_FILE="$MT5_EXPERTS_DIR/HyperactiveHFTMT5_GOLD.mq5"
...
# Copy the file
echo "Copying HyperactiveHFTMT5_GOLD.mq5 to MetaTrader 5..."
...
if [ $? -eq 0 ]; then
    ...
    echo "3. Find 'HyperactiveHFTMT5_GOLD.mq5' in the Navigator (under Experts)"
