...
# Script to copy GibsonScalpterV1.mq5 to MetaTrader 5 Experts folder
...
# Source file
SOURCE_FILE="GibsonScalpterV1/GibsonScalpterV1.mq5"
...
echo "=========================================="
echo "GibsonScalpterV1 - MetaTrader 5 Copy Script"
echo "=========================================="
echo ""
...
if [ -z "$MT5_EXPERTS_DIR" ]; then
    ...
    if [ -z "$MT5_EXPERTS_DIR" ]; then
        ...
        echo "  To:   [Your MT5 Installation]/MQL5/Experts/GibsonScalpterV1.mq5"
        exit 1
    fi
fi

DEST_FILE="$MT5_EXPERTS_DIR/GibsonScalpterV1.mq5"
...
# Copy the file
echo "Copying GibsonScalpterV1.mq5 to MetaTrader 5..."
...
if [ $? -eq 0 ]; then
    ...
    echo "3. Find 'GibsonScalpterV1.mq5' in the Navigator (under Experts)"
