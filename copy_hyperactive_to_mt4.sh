...
# Script to copy HyperactivePulseScalper.mq4 to MetaTrader 4 Experts folder
# Usage: ./copy_hyperactive_to_mt4.sh
...
# Source file
SOURCE_FILE="HyperactivePulseScalper/HyperactivePulseScalper.mq4"
...
echo "=========================================="
echo "HyperactivePulseScalper - MetaTrader 4 Copy Script"
echo "=========================================="
echo ""
...
if [ -z "$MT4_EXPERTS_DIR" ]; then
    ...
    if [ -z "$MT4_EXPERTS_DIR" ]; then
        ...
        echo "  To:   [Your MT4 Installation]/MQL4/Experts/HyperactivePulseScalper.mq4"
        echo ""
...
DEST_FILE="$MT4_EXPERTS_DIR/HyperactivePulseScalper.mq4"
...
if [ $? -eq 0 ]; then
    ...
    echo "3. Find 'HyperactivePulseScalper.mq4' in the Navigator (under Experts)"
