#!/bin/bash
# Script to copy EA to MT5 Experts directory

SOURCE_FILE="HybridTrendPullbackMT5/HybridTrendPullback_Universal.mq5"
EA_NAME="HybridTrendPullback_Universal.mq5"
